...
4. Настраиваем апач, чтобы папка с проектом откликалась по хостам "floxim" и "jeeptravel.loc" (наши демо-сайты)
5. Входим под админом вот так: http://floxim/floxim/ | admin@floxim | 111
