...
--
-- Хост: localhost
-- Время создания: Сен 25 2013 г., 14:16
...
CREATE TABLE IF NOT EXISTS `fx_content` (
  ...
  `parent_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=47 AUTO_INCREMENT=2113 ;
...
(2112, 23, 1, '2013-09-25 14:06:40', '2013-09-25 10:06:40', 99, 'comment', 127, 15, 1996);
...
INSERT INTO `fx_content_comment` (`id`, `comment_text`, `publish_date`, `user_name`) VALUES
(2112, 'jkjkjk', '2013-09-25 14:06:40', 'asdfasdf');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=95 AUTO_INCREMENT=222 ;
...
(195, NULL, 30, 0, 0, 0, 'tags', 'Tags', 14, 'a:2:{s:6:"target";s:7:"198.186";s:11:"render_type";s:10:"livesearch";}', 0, 2, 0, '', 0, 1, 1),
...
CREATE TABLE IF NOT EXISTS `fx_filetable` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=56 AUTO_INCREMENT=426 ;
...
('0d55df949059cd7b77182b82c696585f', 99, 1380024147, 1380190530, 2130706433, 0, 0, 1);
