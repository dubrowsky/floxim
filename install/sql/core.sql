...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 12 2014 г., 17:16
...
CREATE TABLE IF NOT EXISTS `fx_content` (
  ...
  `parent_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=47 AUTO_INCREMENT=2750 ;
...
(2744, 270, 1, '2014-03-11 21:59:51', '2014-03-11 17:59:51', 2367, 'section', 346, 18, 2638),
...
(2058, '/floxim_files/content/photo/2001-2100/photo/7394_0_0.jpg', '<p>\r\n	 Это же Саша Васильев!\r\n</p>', ''),
...
CREATE TABLE IF NOT EXISTS `fx_filetable` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=56 AUTO_INCREMENT=609 ;
...
CREATE TABLE IF NOT EXISTS `fx_infoblock` (
  ...
  PRIMARY KEY (`id`),
  KEY `page_id` (`page_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=210 AUTO_INCREMENT=403 ;
...
(378, 345, 18, 2657, 1, '', '', '', 'a:0:{}', 'a:2:{s:5:"pages";s:11:"descendants";s:9:"page_type";s:0:"";}'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=138 AUTO_INCREMENT=475 ;
...
('07d05925ab00d27f3543c6d63a900188', 2367, 1394538932, 1394627222, 2130706433, 0, 0, 1),
('d4020b281f4a0b68b7704ecf86beecef', 2367, 1394540883, 1394716403, 2130706433, 0, 0, 1);
