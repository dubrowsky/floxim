...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 28 2014 г., 20:35
...
CREATE TABLE IF NOT EXISTS `fx_content` (
  ...
  `parent_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=47 AUTO_INCREMENT=2724 ;
...
(2653, 2, 1, '2014-01-30 13:34:27', '2014-02-17 06:42:35', 2367, 'section', 346, 18, 2638),
(2654, 3, 1, '2014-01-30 13:34:34', '2014-02-17 06:42:35', 2367, 'section', 346, 18, 2638),
...
(2714, 252, 1, '2014-02-28 12:45:38', '2014-02-28 08:45:38', 2367, 'classifier_linker', 315, 17, 2572),
(2715, 252, 1, '2014-02-28 12:45:38', '2014-02-28 08:45:38', 2367, 'classifier_linker', 315, 17, 2572),
...
(2653, '/minesweeperz', 'Mine sweeper', 'Category 2', 0),
...
(2058, '/floxim_files/content/7394_0.jpg', '<p>\r\n	Это же Саша Васильев!\r\n</p>', ''),
...
(2662, '', '<p>\r\n	 Cargo ships are so cargo!\r\n</p>', '\n                Trust me', '/floxim_files/content/bg-portfolio_6.jpg', 1500);
...
INSERT INTO `fx_content_publication` (`id`, `publish_date`, `anounce`, `image`, `text`, `test_num`) VALUES
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=95 AUTO_INCREMENT=304 ;
...
(302, NULL, 49, 0, 0, 0, 'test_num', 'Test number', 2, '', 0, 255, 0, '', 0, 1, 1, 0),
(303, NULL, 68, 0, 0, 0, 'contacts', 'test field for contacts', 14, 'a:3:{s:11:"render_type";s:5:"table";s:13:"linking_field";s:3:"196";s:16:"linking_datatype";s:2:"70";}', 0, 256, 0, '', 0, 1, 1, 1);
...
CREATE TABLE IF NOT EXISTS `fx_filetable` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=56 AUTO_INCREMENT=556 ;
...
CREATE TABLE IF NOT EXISTS `fx_infoblock` (
  ...
  PRIMARY KEY (`id`),
  KEY `page_id` (`page_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=210 AUTO_INCREMENT=401 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=138 AUTO_INCREMENT=473 ;
...
(417, 345, 12, '', '', 'layout_v3.two_columns_inverted', 'a:3:{s:5:"phone";s:17:"8 (800) 123 12 42";s:4:"logo";s:32:"/floxim_files/content/7394_0.jpg";s:17:"two_column_header";s:39:"Catalog                                ";}', '', 1),
...
(433, 361, 12, '', '', 'layout_v3.featured_list', 'a:4:{s:5:"image";s:38:"/floxim_files/content/HansIsland_0.png";s:10:"image_2652";s:38:"/floxim_files/content/HansIsland_2.png";s:10:"four_items";s:1:"1";s:8:"image_id";s:32:"/floxim_files/content/7394_0.jpg";}', 'main_column', 2),
(434, 362, 12, '', '', 'layout_v3.banner', 'a:2:{s:18:"banner_header_2652";s:26:"<p>\n	Best Icebreakers\n</p>";s:16:"banner_text_2652";s:58:"Check <strong>our </strong><strong>best </strong>deals<br>";}', 'main_column', 1),
...
(441, 369, 12, '', '', 'layout_v3.banner', 'a:2:{s:18:"banner_header_2660";s:21:"<p>\n	Greate ship\n</p>";s:16:"banner_text_2660";s:42:"Ship of <strong>this<br>\nweek</strong><br>";}', 'main_column', 5),
(442, 370, 12, 'layout_v3.right_block_titled', 'a:1:{s:6:"header";s:10:"Best ships";}', 'layout_v3.featured_list', 'a:1:{s:10:"four_items";s:1:"0";}', 'main_column', 6),
...
(448, 376, 12, '', '', 'layout_v3.vacancy_record', '', 'main_column', 9),
(449, 377, 12, '', '', 'layout_v3.vacancies_list', '', 'main_column', 10),
...
(457, 385, 12, '', '', 'layout_v3.full_screen_menu', 'a:9:{s:7:"bg_2688";s:38:"/floxim_files/content/HansIsland_8.png";s:3:"bg_";s:0:"";s:7:"bg_2690";s:69:"/floxim_files/content/1280px-Sortie_de_l_op_ra_en_l_an_2000-2_1_0.jpg";s:11:"header_2688";s:50:"<p>\n	         Hans Island\n</p>\n<p>\n	...rocks!\n</p>";s:12:"caption_2688";s:56:"This writing is all about<br>\n<strong>SPARTAAA</strong>!";s:11:"header_2690";s:0:"";s:11:"header_2639";s:41:"<p>\n	Our projects\n</p>\n<p>\n	are cool\n</p>";s:12:"caption_2639";s:11:"Ain''t they?";s:12:"caption_2690";s:13:"Lorem figorum";}', 'full_screen', 1),
...
(463, 391, 12, '', '', 'layout_v3.banner', '', 'main_column', 13),
...
(470, 398, 12, '', '', 'component_news.record', '', 'main_column', 16),
...
('2aab7471aea7579b1e0c7bb891ac169a', 2367, 1393147068, 1393581681, 2130706433, 0, 0, 1),
('4bb1b6bd97a6d1cce1056f1f0b913c23', 2367, 1393520677, 1393691650, 2130706433, 0, 0, 1),
('edb7f081c0d8c3c5a0c4553600b740cb', 2367, 1393519698, 1393606762, 2130706433, 0, 0, 1),
('eec0327d91ee9183b397cef268228b8f', 2367, 1393501367, 1393594816, 2130706433, 0, 0, 1);
