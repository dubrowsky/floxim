<?
class fx_template_html_tokenizer_dev extends fx_template_fsm {
    const TEXT = 1;
    const TAG = 2;
    const PHP = 3;
    const ATT_NAME = 5;
    ...
    public function __construct() {
        ...
        $this->add_rule(self::TAG, ' ', self::ATT_NAME);
        $this->add_rule(self::ATT_NAME, array('="', "='"), self::ATT_VAL, 'att_value_start');
