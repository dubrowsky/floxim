...
class fx_field_text extends fx_field_baze {
    ...
    public function format_settings() {
        $fields[] = array('type' => 'checkbox', 'name' => 'format[html]', 'label' => 'разрешить html-теги', 'value' => $this['format']['html']);
        $fields[] = array('type' => 'checkbox', 'name' => 'format[nl2br]', 'label' => 'заменять перенос строки на br', 'value' => $this['format']['nl2br']);
        return $fields;
    }
