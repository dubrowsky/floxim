<?php
class fx_controller_page extends fx_controller {

    /**
     * Отображает страницу
     * @return array собранные части страницы
     */
    public function show() {
        ...
        //dev_log('page controller res', $areas);
    ...
    public function admin() {
        ...
        if (!$fx_core->env->get_user()) {
            $auth_form = '<div>
                ...
                <input type="hidden" name="essence" value="page" />
