...
$cache_folder = fx::config()->FILES_FOLDER.'phpthumb/';
...
$PHPTHUMB_CONFIG['cache_directory'] = $cache_folder;                           // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = $cache_folder.'source/';  // set the cache directory for unprocessed source images
